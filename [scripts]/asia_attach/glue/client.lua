...
local globalGlueHelis = false --Allow helicopters to attach vehicles to them (pick them up into the air)
local allowedGeneralVehicles = {} --Whitelist if globalGlueVehicles is false
local allowedHelis = {} --Whitelist if globalGlueHelis is false
