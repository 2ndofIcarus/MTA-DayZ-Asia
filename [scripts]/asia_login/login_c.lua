...
login.window[1] = guiCreateWindow(sW*0.4, sH*0.384, 243, 152, "Please log in to continue!", false)
...
login.button[1] = guiCreateButton(10, 114, 107, 29, "Login", false, login.window[1])
...
register.window[1] = guiCreateWindow(sW*0.4, sH*0.384, 243, 237, "Register your account.", false)
...
register.button[1] = guiCreateButton(10, 198, 107, 29, "Create", false, register.window[1])
