	...
	if (keyState == "down") then
		...
		if (itemName == "deadreason") then
			...
			if (dtype == "player") then
				outputChatBox("#880808[DayZ PH]#D3D3D3 "..t1.." "..getLanguageTextClient(t2).." "..getLanguageTextClient(t4)..". "..getLanguageTextClient(t5).." "..t6..":"..t7.." "..getLanguageTextClient(t8), 211, 211, 211, true);
			elseif (dtype == "other") then
				outputChatBox("#880808[DayZ PH]#D3D3D3 "..getLanguageTextClient(t1).." "..t2..":"..t3.." "..getLanguageTextClient(t4), 211, 211, 211, true);
			end
			return;
		end
