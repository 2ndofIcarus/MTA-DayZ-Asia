...
function refreshItemLootPoints()
	outputChatBox("#880808[Warning] #D3D3D3Item loot respawn in 1 minute!", root, 255, 255, 255, true);
	outputChatBox("#880808[Warning] #D3D3D3All players, vehicles & peds will freez in 50 seconds!", root, 255, 255, 255, true);
